  ...
  <footer className="footer">
    <div className="footer-top">
      <div className="footer-brand">
        ...
        <p>
          Erode's trusted HR consultancy delivering end-to-end workforce
      ...
      <div className="footer-col">
        ...
        <ul>
          ...
          <li>
            <Link to="/jobs">Current Jobs</Link>
          </li>
          <li>
      ...
      <div className="footer-col">
        ...
        <ul>
          ...
          <li>
            <Link to="/services">Statutory Compliance</Link>
          </li>
          <li>
            <Link to="/services">Training & Development</Link>
          </li>
          <li>
            <Link to="/services">HR Policy Design</Link>
          </li>
        </ul>
      </div>
      ...
      <div className="footer-col">
        ...
        <ul>
          <li>
            <Link to="/candidate/register">Register Profile</Link>
          </li>
          <li>
        ...
        <ul className="footer-contact-list">
          <li>
            <FaPhone /> <a href="tel:+917418615555">+91 74186 71555</a>
          </li>
          <li>
            <FaEnvelope />{" "}
    ...
    <div className="footer-bottom">
      <p>
        © {new Date().getFullYear()} AVB Manpower Solutions, Erode. All rights
        reserved.
      </p>
      <p>Designed with Fully Joy for Erode's workforce</p>
    </div>
  </footer>
);
