    ...
    <>
      <section className="page-hero">
        <div className="page-hero-content">
          ...
          <h1>Contact Us</h1>
          <p>
            Reach out to our team in Erode — we typically respond within 24
            hours
          </p>
        </div>
      </section>
      ...
      <section className="contact-section">
        <div className="contact-grid">
          ...
          <div className="contact-info">
            <h2>Get in Touch</h2>
            <p>
              Whether you're an employer looking for talent or a candidate
              seeking your next opportunity, our team is ready to help.
            </p>
            ...
            <div className="contact-cards">
              <div className="contact-info-card">
                ...
                <div>
                  ...
                  <p>
                    AVB Manpower Solutions
                    <br />
                    149/1, First Floor,
                    <br />
                    Dhana Complex,
                    <br />
                    Near A2B, Mettur Road,
                    <br />
                    Erode - 638001
                    <br />
                    Tamil Nadu, India
        ...
        <div className="map-wrap">
          <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3911.8601482510708!2d77.71856!3d11.344923999999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTHCsDIwJzQxLjciTiA3N8KwNDMnMDYuOCJF!5e0!3m2!1sen!2sin!4v1773815760337!5m2!1sen!2sin"
            width="100%"
            height="350"
